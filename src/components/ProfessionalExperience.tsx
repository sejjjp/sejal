...
export function ProfessionalExperience() {
  return (
    <div id="experience" className="relative bg-gradient-to-br from-[rgba(249,250,251,0.5)] via-white to-[rgba(250,245,255,0.3)] py-16 md:py-24 px-4 md:px-8 lg:px-12 overflow-hidden" data-name="ProfessionalExperience">
      {/* Decorative background elements */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          className="absolute top-20 left-10 w-12 h-12 md:w-16 md:h-16 rounded-full opacity-30"
          style={{ backgroundImage: "linear-gradient(135deg, rgb(218, 178, 255) 0%, rgb(253, 165, 213) 100%)" }}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.p 
            className="font-['Caveat',sans-serif] text-[#99a1af] text-2xl md:text-3xl mb-2"
          ...
          <h2 className="font-['Playfair_Display',sans-serif] text-[#101828] text-3xl md:text-4xl lg:text-5xl">
          ...
          >
            <div className="relative">
              ...
              <div 
                ...
                style={{ backgroundImage: "linear-gradient(156.995deg, rgb(223, 234, 254) 7.9104%, rgb(241, 233, 251) 50%, rgb(244, 232, 246) 92.09%)" }}
              />
          ...
          >
            ...
            >
              {[
                ...
                >
                  <span className="text-[#ad46ff] text-xl flex-shrink-0 leading-7">•</span>
                  <span className="leading-[1.625]">{item}</span>
                </motion.li>
              ))}
            </motion.ul>
            ...
            >
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => window.open('https://drive.google.com/file/d/15aqvw89Qhh2A167Bg-MFqj2wwsDH2V4f/view?usp=sharing', '_blank')}
              >
